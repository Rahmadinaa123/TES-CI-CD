...
<head>
    ...
    <style>
        ...
        .alamat {
            ...
            margin-right: 20px;
            /* Membuat formulir berada di tengah halaman */
        }
    ...
    <div>
        <section>
            <div class="container pt-5">
                ...
                <h2>Pengiriman</h2>
                <form class="mt-4 mb-4" action="{{ route('postPengiriman.user') }}" method="post">
                    @csrf
                    <div class="alamat">
                        ...
                        <div class="form-group">
                            <textarea class="form-control" name="alamat_pengiriman" placeholder="Masukkan alamat baru" rows="4"
                                cols="50">{{ Auth::user()->alamat }}</textarea>
                        </div>
                    </div>
                    <br>
                            ...
                            <table class="ml-5">
                                <tr>
                                    ...
                                    <td class=""><input class="form-control" name="total_harga_barang"
                                            type="text" value="{{ $hargaObat }}"></td>
                                </tr>
                                <tr>
                                    <td class="mb-3 col-md-6">Total Belanja</td>
                                    <td class=""><input class="form-control" name="total_belanja"
                                            value="{{ $totalHarga }}" type="text"></td>
                                </tr>

                            </table>
                            <br>
                            <button type="submit" class="btn btn-warning">Pilih Metode Pembayaran</button>
                        </div>
                    </div>
                    <br>
                </form>
