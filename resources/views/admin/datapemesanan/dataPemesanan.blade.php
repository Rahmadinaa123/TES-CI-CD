        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div>
                        <div class="col-12">
                            <a class="btn btn-success" href="{{ route('admin.tambahdataPemesanan') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-outline-success"
                                                href="/admin/dataPemesanan/detail/{{ $item->id }}">Detail</a>
                                            <a class="btn btn-outline-warning"
                                                href="/editPemesanan/{{ $item->id }}">Edit</a>
                                            <a class="btn btn-outline-danger"
                                                href="/deletePemesanan/{{ $item->id }}">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
