                                ...
                                <div class="card-body">
                                    ...
                                    <form action="/posteditPemesanan/{{ $data->id }}" method="POST"
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <input type="text"
                                                class="form-controlborder border-secondary form-control"
                                        ...
                                        <div class="form-group mt-1">
                                            <label class="text-secondary mb-2">Harga Obat</label>
                                            <input type="text"
                                                class="form-controlborder border-secondary form-control"
                                                name="harga_obat" required value="{{ $data->harga_obat }}">
                                            <span class="text-danger">
                                                @error('harga_obat')
                                                    {{ $message }}
                                                @enderror
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <input type="number"
                                                class="form-controlborder border-secondary form-control"
                                                name="kuantitas" required value="{{ $data->kuantitas }}">
                                            <span class="text-danger">
                                                @error('kuantitas')
                                                    {{ $message }}
                                                @enderror
                                        ...
                                        <div class="form-group mt-1">
                                            <label class="text-secondary mb-2">Total Harga</label>
                                            <input type="text"
                                                class="form-controlborder border-secondary form-control"
                                                name="total_harga" required value="{{ $data->total_harga }}">
                                            <span class="dosis_obat">
                                                @error('total_harga')
                                                    {{ $message }}
                                                @enderror
                                            </span>
                                        ...
                                        <div class="form-group mt-1">
                                            <label class="text-secondary mb-2">Waktu Pengiriman</label>
                                            <input type="text"
                                                class="form-controlborder border-secondary form-control"
                                                name="waktu_pengiriman" required
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <input type="text"
                                                class="form-controlborder border-secondary form-control"
                                                name="id_user" required value="{{ $data->id_user }}">
                                            <span class="text-danger">
                                                @error('id_user')
                                                    {{ $message }}
                                                @enderror
