    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">SMART FARMA tes</sup></div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div>
                        <div class="col-12">
                            <a class="btn btn-success" href="{{ route('admin.tambahdataObat') }}"
                        ...
                        <table class="table" style="margin-top: 10px">
                            <thead>
                                <tr>
                                    ...
                                    <th class="col-md-3" scope="col">Deskripsi</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-outline-success"
                                                href="/admin/dataObat/detail/{{ $item->id }}">Detail</a>
                                            <a class="btn btn-outline-warning"
                                                href="/editObat/{{ $item->id }}">Edit</a>
