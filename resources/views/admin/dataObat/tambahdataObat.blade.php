        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.dataPemesanan') }}">
                    <i class="fas fa-fw fa-user"></i>
                    <span>Data Pemesanan obat</span></a>
            </li>
            <li class="nav-item">
                                    ...
                                    <form action="{{ route('admin.postObat') }}" method="POST"
                                        ...
                                        <div class="form-group mt-4">
                                            ...
                                            <input type="text" class="form-control border border-secondary"
                                                name="nama_obat" required value="{{ old('nama_obat') }}">
                                        ...
                                        <div class="form-group mt-1">
                                            <label class="text-secondary mb-2">No Edar</label>
                                            <input type="text" class="form-control border border-secondary"
                                                name="no_edar" required value="{{ old('no_edar') }}">
                                            <span class="text-danger">
                                                @error('no_edar')
                                                    {{ $message }}
                                                @enderror
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <textarea class="form-control border border-secondary" name="komposisi" required>{{ old('komposisi') }}</textarea>
                                            <span class="text-danger">
                                                @error('komposisi')
                                                    {{ $message }}
                                                @enderror
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <input type="text" class="form-control border border-secondary"
                                                name="kemasan" required value="{{ old('kemasan') }}">
                                            <span class="text-danger">
                                                @error('kemasan')
                                                    {{ $message }}
                                                @enderror
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <input type="text" class="form-control border border-secondary"
                                                name="dosis" required value="{{ old('dosis') }}">
                                            <span class="text-danger">
                                                @error('dosis')
                                                    {{ $message }}
                                                @enderror
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <input type="text" class="form-control border border-secondary"
                                                name="manfaat" required value="{{ old('manfaat') }}">
                                            <span class="text-danger">
                                                @error('manfaat')
                                                    {{ $message }}
                                                @enderror
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <input type="text" class="form-control border border-secondary"
                                                name="cara_mengonsumsi" required
                                                value="{{ old('cara_mengonsumsi') }}">
                                            <span class="text-danger">
                                        ...
                                        <button type="submit" class="btn btn-success mt-5">Tambah Data Obat</button>
                                    </form>
