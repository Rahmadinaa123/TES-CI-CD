                            ...
                            <div class="card mt-4" style="width: 800px">
                                <div class="card-body">
                                    <h5 class="card-title text-center">Edit Data
                                        Pengiriman</h5>
                                    <form action="/postEditPengiriman/{{ $data->id }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group mt-4">
                                            <label class="text-secondary mb-2">Alamat Pengiriman</label>
                                        ...
                                        <div class="form-group mt-1">
                                            <label class="text-secondary mb-2">Nama Pelanggan</label>
                                            <input type="text"
                                                class="form-controlborder border-secondary form-control"
                                                name="nama_pelanggan" required value="{{ $data->nama_pelanggan }}">
                                            <span class="text-danger">
                                        ...
                                        <div class="form-group mt-1">
                                            <label class="text-secondary mb-2">Total Harga Barang</label>
                                            <input type="text"
                                                class="form-controlborder border-secondary form-control"
                                                name="total_harga_barang" required
                                                value="{{ $data->total_harga_barang }}" readonly>
                                            <span class="text-danger">
