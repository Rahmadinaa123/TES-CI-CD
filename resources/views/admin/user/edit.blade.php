...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.dataPelanggan') }}">
                    <i class="fas fa-fw fa-user"></i>
                            ...
                            <div class="card mt-4" style="width: 800px">
                                <div class="card-body">
                                    <h5 class="card-title text-center">Edit Data
                                        User</h5>
                                    <form action="/postEditUser/{{ $data->id }}" method="POST"
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <select class="form-control" id="exampleFormControlSelect1"
                                                ...
                                                <option value="Apoteker"
                                                    {{ $data->level === 'Apoteker' ? 'selected' : '' }}>Apoteker
                                                </option>
                                                <option value="Pengguna"
                                                    {{ $data->level === 'Pengguna' ? 'selected' : '' }}>Pengguna
                                                </option>
                                            </select>
