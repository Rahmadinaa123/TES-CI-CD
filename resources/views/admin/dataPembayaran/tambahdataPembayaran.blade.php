                            ...
                            <div class="card mt-4" style="width: 800px">
                                <div class="card-body">
                                    <h5 class="card-title text-center">Tambah Data
                                        Pembayaran</h5>
                                    <form action="{{ route('admin.postPemesanan') }}" method="POST"
                                        ...
                                        <div class="form-group mt-4">
                                            ...
                                            <input type="text"
                                                ...
                                                name="nama_pemesan" required value="{{ old('nama_pemesan') }}">
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <input type="text"
                                                class="form-controlborder border-secondary form-control"
                                                name="obat" required value="{{ old('obat') }}">
                                            <span class="text-danger">
                                                @error('obat')
                                                    {{ $message }}
                                                @enderror
                                        ...
                                        <div class="form-group mt-1">
                                            <label class="text-secondary mb-2">Detail Pembelian</label>
                                            <input type="text"
                                                class="form-controlborder border-secondary form-control"
                                                name="detail_pembelian" required
                                                value="{{ old('detail_pembelian') }}">
                                            <span class="text-danger">
                                                @error('detail_pembelian')
                                                    {{ $message }}
                                                @enderror
                                            </span>
                                        </div><br>
                                        ...
                                        <button type="submit" class="btn btn-success mt-5">Tambah Data
                                            Pemesanan</button>
                                    </form>
                                </div>
                            </div>
