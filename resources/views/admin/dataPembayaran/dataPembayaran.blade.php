        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div>
                        <div class="col-12">
                            <a class="btn btn-success" href="{{ route('admin.tambahdataPembayaran') }}"
                                style="text-decoration: none; margin-left: 30px">Tambah
                                Data
                                +</a>
                            <a class="btn btn-warning" href="{{ route('admin.BuktiPembayaran') }}"
                                style="text-decoration: none; margin-left: 30px">Lihat Bukti Pembayaran</a>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-outline-success"
                                                href="/admin/dataPembayaran/detail/{{ $item->id }}">Detail</a>
                                            <a class="btn btn-outline-warning"
                                                href="/editPembayaran/{{ $item->id }}">Edit</a>
                                            <a class="btn btn-outline-danger"
                                                href="/deletePembayaran/{{ $item->id }}"
                                                onclick="return confirm('Apakah Anda yakin ingin menghapus pembayaran ini?')">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
