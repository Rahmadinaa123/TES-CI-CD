                            ...
                            <div class="card mt-4" style="width: 800px">
                                <div class="card-body">
                                    <h5 class="card-title text-center">Edit Data
                                        Pemesanan</h5>
                                    <form action="/posteditPembayaran/{{ $data->id }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group mt-4">
                                            <label class="text-secondary mb-2">Kode Pemesanan</label>
                                            <input type="text" class="form-control border border-secondary"
                                                name="kode_pemesanan" required value="{{ $data->kode_pemesanan }}"
                                                readonly>
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <input type="text" class="form-control border border-secondary"
                                                ...
                                                value="{{ $data->tanggal_pemesanan }}" readonly>
                                            <span class="text-danger">
                                        ...
                                        <div class="form-group mt-1">
                                            <label class="text-secondary mb-2">Nama Pemesan</label>
                                            <input type="text" class="form-control border border-secondary"
                                                name="nama_pemesan" required value="{{ $data->nama_pemesan }}"
                                                readonly>
                                            <span class="text-danger">
                                                @error('nama_pemesan')
                                                    {{ $message }}
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <input type="text" class="form-control border border-secondary"
                                                name="alamat" required value="{{ $data->alamat }}" readonly>
                                            <span class="text-danger">
                                                @error('alamat')
                                                    {{ $message }}
                                                @enderror
                                        ...
                                        <div class="form-group mt-1">
                                            <label class="text-secondary mb-2">Metode Pengiriman</label>
                                            <input type="text" class="form-control border border-secondary"
                                                name="metode_pengiriman" required
                                                value="{{ $data->metode_pengiriman }}" readonly>
                                            <span class="text-danger">
                                        ...
                                        <div class="form-group mt-1">
                                            <label class="text-secondary mb-2">Metode Pembayaran</label>
                                            <input type="text" class="form-control border border-secondary"
                                        ...
                                        <div class="form-group mt-1">
                                            <label class="text-secondary mb-2">Obat</label>
                                            <input type="text" class="form-control border border-secondary"
                                                name="obat" required value="{{ $data->obat }}" readonly>
                                            <span class="text-danger">
                                                @error('obat')
                                                    {{ $message }}
                                                @enderror
                                        ...
                                        <div class="form-group mt-1">
                                            <label class="text-secondary mb-2">Kuantitas</label>
                                            <input type="number" class="form-control border border-secondary"
                                                name="kuantitas" required value="{{ $data->kuantitas }}" readonly>
                                            <span class="text-danger">
                                                @error('kuantitas')
                                                    {{ $message }}
                                                @enderror
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <input type="text" class="form-control border border-secondary"
                                                name="harga" required value="{{ $data->harga }}" readonly>
                                            <span class="text-danger">
                                                @error('harga')
                                                    {{ $message }}
                                                @enderror
                                        ...
                                        <div class="form-group mt-1">
                                            <label class="text-secondary mb-2">Total Belanja</label>
                                            <input type="text" class="form-control border border-secondary"
                                                name="total_belanja" required value="{{ $data->total_belanja }}"
                                                readonly>
                                            <span class="text-danger">
                                                @error('total_belanja')
                                                    {{ $message }}
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <select class="form-control border border-secondary" name="status"
                                                required>
                                                <option value="menunggu pembayaran"
                                                    {{ $data->status == 'menunggu pembayaran' ? 'selected' : '' }}>
                                                    Menunggu Pembayaran</option>
                                                <option value="sedang dikemas"
                                                    {{ $data->status == 'sedang dikemas' ? 'selected' : '' }}>
                                                    Sedang
                                                    Dikemas</option>
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <input type="text" class="form-control border border-secondary"
                                                name="id_user" required value="{{ $data->id_user }}" readonly>
                                            <span class="text-danger">
                                                @error('id_user')
                                                    {{ $message }}
                                                @enderror
                                        ...
                                        <button type="submit" class="btn btn-success mt-5">Edit Data
                                            Pemesanan</button>
                                    </form>
